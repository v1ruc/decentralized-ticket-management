...
In order to create DID you need to use `deploy-passport` tool which is a part of Monetha's Platform (Go SDK). Follow [README](https://github.com/monetha/go-verifiable-data) instructions to build the tool.
